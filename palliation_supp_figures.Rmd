...
$p_{i,n} - p_{j,n}$, where $p_{i,n}$ is the proportion of text from cohort $i$ that is about topic $n$. Whiskers represent Bayesian 95% credible intervals.  


```{r, results = "asis", eval = T}

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:10),
                         model = fit, method = "difference", cov.value1 = "cat1", cov.value2 = "cat2",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat1 vs cat2")

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:11),
                         model = fit, method = "difference", cov.value1 = "cat1", cov.value2 = "cat3",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat1 vs cat3")

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:11),
                         model = fit, method = "difference", cov.value1 = "cat1", cov.value2 = "cat4",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat1 vs cat4")

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:11),
                         model = fit, method = "difference", cov.value1 = "cat2", cov.value2 = "cat3",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat2 vs cat3")

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:11),
                         model = fit, method = "difference", cov.value1 = "cat2", cov.value2 = "cat4",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat2 vs cat4")

plot.estimateEffect(fx, covariate = "cat", topics = c(1:6, 8:11),
                         model = fit, method = "difference", cov.value1 = "cat3", cov.value2 = "cat4",
                         labeltype = "custom", custom.labels = topic.labels, main = "cat3 vs cat4")
